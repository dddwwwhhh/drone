...
#####################################################################################################
    ...
    while True:
        ...
        # the frame
        cv2.putText(frame, str(stage), (10, 30), cv2.FONT_HERSHEY_SIMPLEX,
            0.65, (0, 0, 255), 3)
...
##                print ("-------")
                ...
                if radius<30:
                    drone.vrc_control(1024+fly_speed, 1024, 1024-5, 1024)
                elif rasius>130:
                    drone.vrc_control(1024+fly_speed, 1024, 1024+5, 1024)
                elif rasius<130 and rasius>30:
                    stage=5
                ...
                if x>400: # lower 
                    ...
                    if y>275:
                        ...
                        drone.vrc_control(1024, 1024, 1024, 1024)
                        lr,lg,lb=(29,70,6) # change color if needs
                        hr,hg,hb=(64,255,255)
                        stage=7
            elif stage == 7:
                for i in range(100):
                    drone.vrc_control(1024, 1024-fly_speed, 1024, 1024)
                    time.sleep(0.02)
                if target==True and ((abs(lx-x2))>4 or (abs(ly-x2))>4):  
                    stage=8
...
def getinfor():
    ...
    lxi=(infor[(infor.find ('x:' )+2):infor.find ('\ny:' )])
   
    lyi=(infor[(infor.find ('y:' )+2):infor.find('\nz:')])
    
    
    lzi=(infor[(infor.find ('z:' )+2):])
