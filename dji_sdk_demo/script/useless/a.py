...
def main():
    ...
    if True:
        ...
        with picamera.PiCamera() as camera:
            ...
            time.sleep(10)
            print "took off"
            for i in range(250): # 60 times for 3.5 meter 300 for 12.7 meter
            ...
            for i in range(20): # 60 times for 3.5 meter 300 for 12.7 meter
            ...
            for i in range(20): # 60 times for 3.5 meter 300 for 12.7 meter
                ...
                time.sleep(0.02)
            time.sleep(2)
            for i in range(120): # 60 times for 3.5 meter 300 for 12.7 meter
                drone.attitude_control(DJIDrone.HORIZ_POS|DJIDrone.VERT_VEL|DJIDrone.YAW_ANG|DJIDrone.HORIZ_BODY|DJIDrone.STABLE_ON, -1, 0, 0, 0)
                time.sleep(0.02)
            time.sleep(2)
            drone.landing()
